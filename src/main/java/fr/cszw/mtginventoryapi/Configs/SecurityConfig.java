package fr.cszw.mtginventoryapi.Configs;
...
public class SecurityConfig {
    ...
    public static class KeycloakConfigurationAdapter extends KeycloakWebSecurityConfigurerAdapter {
        ...
        public CorsConfigurationSource corsConfigurationSource() {
            ...
            configuration.setAllowedMethods(Arrays.asList(HttpMethod.OPTIONS.name(), "GET","POST", "DELETE"));
    ...
    public static class CommonSpringKeycloakTutorialsSecuritAdapter extends AbstractHttpConfigurer<CommonSpringKeycloakTutorialsSecuritAdapter, HttpSecurity> {
        ...
        public void init(HttpSecurity http) throws Exception {
            ...
            http
                    ...
                    .antMatchers("/places/*", "/places").authenticated()
                    .antMatchers("/collection/*", "/collection").authenticated()
